...
<body>
    <div class="container">
        ...
        <div class="info-box">
            ...
            <p style="margin-bottom: 1rem;"><span class="highlight">Understanding the Differential</span></p>
            ...
            <p style="margin-top: 0.75rem;">The <span class="highlight">differential</span> compares the top prize percentage to the bottom prize percentage. When more top prizes remain proportionally than bottom prizes (a <span class="positive">positive differential</span>), each ticket you buy has a higher expected value than a game where the top prizes have already been claimed.</p>
            <p style="margin-top: 0.75rem;"><span class="highlight">Example:</span> If a game has 80% of top prizes remaining but only 50% of bottom prizes remaining, the differential is +30%. This suggests the big prizes are still out there waiting to be won.</p>
            <p style="margin-top: 1rem; font-style: italic; color: var(--text-secondary);">Click any row to view full prize details on the NC Lottery website.</p>
        </div>
        
        <div class="info-box" style="border-color: #ff475744; background: #ff475711;">
            <h3 style="color: var(--accent-red);">⚠️ Important Disclaimer</h3>
            <p><strong style="color: var(--text-primary);">This is not financial advice.</strong> Lottery games are forms of gambling and are inherently risky. A positive differential does not guarantee wins — every ticket is still a game of chance. Past results do not predict future outcomes. Only play with money you can afford to lose.</p>
            <p style="margin-top: 1rem;"><strong style="color: var(--text-primary);">If you or someone you know has a gambling problem, help is available.</strong></p>
            <p>Call or text the National Problem Gambling Helpline: <strong style="color: var(--accent-gold);">1-800-522-4700</strong> (available 24/7, free and confidential).</p>
        </div>
