...
def generate_html(results: List[Tuple[GameData, float, float, float]]) -> str:
    ...
    def generate_game_rows(games, limit=None):
        rows = ""
    ...
    <div class="container">
        ...
        <section>
            <div class="section-header">
                <h2 class="section-title"><span class="icon">💰</span> Games $10 and Up</h2>
                <span class="section-count">{len(high_price_games)} games</span>
            </div>
        ...
        <section>
            <div class="section-header">
                <h2 class="section-title"><span class="icon">🎫</span> Games Under $10</h2>
                <span class="section-count">{len(low_price_games)} games</span>
            </div>
            <div class="table-container">
                <table>
                    <thead>
